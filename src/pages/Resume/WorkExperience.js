    ...
    return (
      <div className="container">
        ...
        <div className="subTitle">
          <p className="place">Redbee</p>
          <p className="time">Feb 2021 - Present</p>
        </div>
        <p className="description">
          <span style={{ color: '#27ade3' }}>• </span>
          Worked for client Banco Itau in the development of cashier system. 
        </p>

        <p className="charge">Fullstack Developer</p>
        <div className="subTitle">
          <p className="place">Zarego</p>
          <p className="time">Sep 2020 - Ene 2021</p>
        </div>
        <p className="description">
          <span style={{ color: '#27ade3' }}>• </span>
          Development of an ABM made in React with redux for a vegan delivery app. 
        </p>
